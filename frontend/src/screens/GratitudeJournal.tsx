...
export default function GratitudeJournal({ onBack }: Props) {
  ...
  return (
    <div style={{ paddingBottom: 32 }}>
      ...
      {/* Edit entry */}
      {editingId && (
        <div className="kb-modal-overlay" style={{ position: 'fixed', inset: 0, background: 'rgba(51,42,45,0.5)', zIndex: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, animation: 'fadeIn 0.2s ease-out' }} onClick={() => setEditingId(null)}>
